                    ...
                    <li class="menuLists">
                        ...
                        <ul class="mm-collapse">
                            <li><a href="${cx}/student/create" id="Item1_1">
                                添加学生信息</a></li>
                            <li><a href="${cx}/student/list" id="Item1_2">查看学生信息
                            </a></li>
                            <li><a href="${cx}/student/query" id="Item1_3">
                                查询学生信息</a></li>
                            <li><a href="${cx}/student/proposer" id="Item1_8">
                                贫困生申请</a></li>
                        </ul>
                    </li>
                    <li class="menuLists">
                        <a class="has-arrow" id="Item1_00"><span class="fa fa-fw fa-book fa-lg"></span>教师信息管理</a>
                        <ul class="mm-collapse">
                            <li><a href="${cx}/Teacher/create" id="Item1_4">添加教师信息</a></li>
                            <li><a href="${cx}/Teacher/list" id="Item1_5">查看教师信息</a></li>
                            <li><a href="${cx}/Teacher/query" id="Item1_6">查询教师信息</a></li>
                        </ul>
                    </li>
                    <li>
